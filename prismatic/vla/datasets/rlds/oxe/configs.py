...
STATE_DIM_MAP = {
    ...
    StateEncoding.POS_EULER: 7,                     # EEF XYZ (3) + Roll-Pitch-Yaw (3) + Gripper Open/Close (1)
...
OXE_DATASET_CONFIGS = {
    "panda_simpler_spoon_dataset":{
        "image_obs_keys": {"primary": "image", "secondary": None, "wrist": None}, # in the save data configuration
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": [],
        "state_encoding": StateEncoding.NONE,
        "action_encoding": ActionEncoding.EEF_POS,
    },
    "panda_simpler_sft_dataset":{
    ...
    "fractal20220817_data": {
        ...
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["base_pose_tool_reached", "gripper_closed"], # 8-dim
